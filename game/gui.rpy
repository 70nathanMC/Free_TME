...
define gui.textbox_background = Composite(
    ...
    (1480, 15), Transform(Text("SYS_OVR//: ACTIVE", size=14, color="#32cd32", kerning=2), alpha=0.4),
...
define gui.button_hover_sound = "audio/ui/hover.ogg"
define gui.button_activate_sound = "audio/ui/main_menu_click.ogg"
